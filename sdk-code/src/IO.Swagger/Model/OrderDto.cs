...
namespace IO.Swagger.Model
{
        ...
        public partial class OrderDto :  IEquatable<OrderDto>, IValidatableObject
    {
        ...
        public OrderDto(int? orderId = default(int?), int? customerId = default(int?), string customerName = default(string), DateTime? orderDate = default(DateTime?), string status = default(string), double? totalAmount = default(double?), string shippingAddress = default(string), string billingAddress = default(string), string notes = default(string), List<OrderItemDto> orderItems = default(List<OrderItemDto>))
        {
